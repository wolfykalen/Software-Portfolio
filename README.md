# Kalen Dacosta - Software Development Portfolio

Welcome to my GitHub portfolio! This repository showcases my best academic projects demonstrating proficiency in software development, data structures, algorithms, and testing.

## 📁 Repository Structure

Each folder represents a course with my strongest projects selected to demonstrate technical skills and problem-solving abilities.

### 🎯 Key Highlights

- **Extensive Testing**: Projects include comprehensive unit tests (perfect for QA/Testing roles)
...
### Languages
- **Java**: Object-oriented design, data structures, GUI development
- **C**: Memory management, pointers, bit manipulation, file I/O
- **Python**: Functions, data processing, algorithms
- **R**: Data analysis, visualization, statistical computing

### Core Concepts
- Data Structures: Arrays, Linked Lists, Trees, Graphs, Hash Tables, Skip Lists, K-D Trees
- Algorithms: Sorting, Searching, Recursion, Dynamic Programming
- Testing: Unit testing, test-driven development, edge case handling
- Software Design: OOP principles, interface design, modularity

## 🚀 How to Run Projects

Each project folder contains its own README with specific setup instructions. Generally:
- **Java Projects**: Use Eclipse or IntelliJ IDEA, run main classes
- **C Projects**: Compile with `gcc`, run executables
- **Python Projects**: `python filename.py`
- **R Projects**: Open in RStudio or R console
...
*This portfolio represents my best academic work selected to demonstrate technical proficiency and problem-solving skills for software development roles.*
