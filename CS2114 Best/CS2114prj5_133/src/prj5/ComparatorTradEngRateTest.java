 ...
 * @version Apr 24, 2025
 */
public class ComparatorTradEngRateTest
    extends TestCase
{
    // ~ Fields ................................................................
    private ComparatorTradEngRate comparator;
    private Data data1;
    private Data data2;
    private Data data3;
    ...
    public void setUp()
    {
        comparator = new ComparatorTradEngRate();
        // formula: ( (comments + likes)/ followers) x 100
        data1 = new Data(
            "January",
            "user1",
            "Apple",
